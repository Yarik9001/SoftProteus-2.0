...
def init():
    ...
    motor0 = PWM(Pin(23), freq=50)
    motor1 = PWM(Pin(23), freq=50)
    motor2 = PWM(Pin(23), freq=50)
    motor3 = PWM(Pin(23), freq=50)
    motor4 = PWM(Pin(23), freq=50)
    motor5 = PWM(Pin(23), freq=50)
    # инициализация светильников 
    led0= PWM(Pin(23), freq=50)
    led1 = PWM(Pin(23), freq=50)
